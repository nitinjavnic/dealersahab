...
$javas.="{ label: '$curr_date', y: $date1 },";
		...
		$data = array('total_seller' => $total_seller, 'totalManufacturer'=>$totalManufacturer,  'totalDealer'=>$totalDealer, 'totalWholesaler'=>$totalWholesaler, 'totalDistributer' =>$totalDistributer,'total_user' => $total_user, 'total_customer' => $total_customer, 'total_booking' => $total_booking,
