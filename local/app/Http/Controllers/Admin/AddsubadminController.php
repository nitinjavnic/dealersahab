...
class AddsubadminController extends Controller
{
    ...
    protected function addsubuserdata(Request $request)
    {
        /*return User::create([
            'name' => $data['name'],
            'email' => $data['email'],
        ...
        else
        {
            ...
            DB::insert('insert into users (name,email,password,phone,photo,admin,gender,subadmin,sellertype) values (?, ?,?, ?,?,?,?,?,?)', [$name,$email,$password,$phone,$namef,2,$gender,1,$sellertype]);
