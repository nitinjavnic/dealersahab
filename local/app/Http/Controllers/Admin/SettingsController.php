...
class SettingsController extends Controller
{
    ...
    protected function editsettings(Request $request)
    {
		...
		live_publish_key="'.$live_publish_key.'",live_secret_key="'.$live_secret_key.'",payu_mode="'.$payu_mode.'",merchant_key="'.$merchant_key.'",salt_id="'.$salt_id.'",
		withdraw_amt="'.$withdraw_amt.'",withdraw_option="'.$withdraw.'",payment_option="'.$payopt.'" where id = ?', [1]);
