...
<body>
	...
	<div class="clearfix"></div>
	<div class="">
	 <div class="col-md-12 fancy" align="center"><h2>Wallet</h2></div>
	 </div>
...
<div class="container">
	...
	<input type="hidden" name="min_with_amt" value="<?php echo $setting[0]->withdraw_amt;?>">
		...
		<div class="col-lg-4 col-md-4 col-sm-4" id="paypal" style="display:none;">
			<div class="form-group">
		...
		<div class="col-lg-4 col-md-4 col-sm-4" id="stripe" style="display:none;">
			<div class="form-group">
		...
		<div class="col-lg-4 col-md-4 col-sm-4" id="payumoney" style="display:none;">
			<div class="form-group">
