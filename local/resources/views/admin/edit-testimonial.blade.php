  ...
  <body class="nav-md">
	...
	@endif
                   ...
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.edit-testimonial') }}" enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }}  
                      <span class="section">Edit Testimonial</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="name" value="<?php echo $testimonials[0]->name; ?>" required="required" type="text">
						  @if ($errors->has('name'))
