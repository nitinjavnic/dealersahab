...
<html lang="en">
  ...
  <body class="nav-md">
	...
	@endif
                   ...
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.editsubservice') }}" enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }}  
					 ...
					 <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="name" value="<?php echo $subservices[0]->subname; ?>" required="required" type="text">
                        @if ($errors->has('name'))
                       ...
                       <div class="item form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                               <input id="name" class="form-control col-md-7 col-xs-12"  name="keywords" value="<?php echo $subservices[0]->keywords; ?>" required="required" type="text">
                           </div>
                       </div>
                       ...
                       <div class="item form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                               <input id="name" class="form-control col-md-7 col-xs-12"  name="title" value="<?php echo $subservices[0]->title; ?>" required="required" type="text">
                           </div>
                       </div>
                       ...
                       <div class="item form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                               ...
                               <textarea  rows = "5" cols = "50"  name ="description"><?php echo $subservices[0]->description; ?></textarea>
