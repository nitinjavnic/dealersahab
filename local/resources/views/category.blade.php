...
$metatag = DB::table('services')
    ->where('id', '=', $service_id[0]->id)
    ->get();
...
<meta name="description" content="<?php echo $metatag[0]->description; ?>" />
<meta name="keywords" content=" <?php echo $metatag[0]->keywords ?>  " />
